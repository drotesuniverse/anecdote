...
export const metadata: Metadata = {
  ...
  description: "Each hoodie in the Anecdote Collection holds a hidden personal layer—a private space where a message, a voice, or a moment is stored securely.",
};
